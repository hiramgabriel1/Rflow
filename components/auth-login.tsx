  ...
  return (
    <div className="bg-card border border-border rounded-xl p-8 shadow-[0_1px_4px_rgba(0,0,0,0.04)]">
      ...
      <div className="flex flex-col gap-3 mb-5">
        <button
          type="button"
          className="flex items-center justify-center gap-2 bg-background border border-border rounded-lg px-4 py-2.5 text-[14px] text-foreground font-medium hover:bg-muted transition-colors"
        >
